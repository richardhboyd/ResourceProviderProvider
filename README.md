...
1. Write the JSON schema describing your resource, `richard-resource-provider.json`
2. Implement your resource handlers in `richard_resource_provider/handlers.py`
